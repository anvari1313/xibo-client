...
class MiscApi(object):
    ...
    def about(self, **kwargs):  # noqa: E501
        ...
        Information about this API, such as Version code, etc  # noqa: E501
    ...
    def clock(self, **kwargs):  # noqa: E501
        """The current CMS time  # noqa: E501

        The Time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.clock(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.clock_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.clock_with_http_info(**kwargs)  # noqa: E501
            return data

    def clock_with_http_info(self, **kwargs):  # noqa: E501
        """The current CMS time  # noqa: E501

        The Time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.clock_with_http_info(async=True)
        >>> result = thread.get()
